...
/*   Updated: 2023/09/13 23:40:49 by srapin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void init_sem(t_data *data)
{
    ...
    data->end = sem_open("end", O_CREAT, 0644, data->number_of_philosophers);
    if (number_of_times_each_philosopher_must_eat_specified(data))
        data->eat_enough = sem_open("eat_enough", O_CREAT, 0644, data->number_of_philosophers);
}
